...
public class GlowRedrawer {
    ...
    private static const GODSLAYERGLOW_FILTER:GlowFilter = new GlowFilter(0, 0.5, 12, 12, 2.5, BitmapFilterQuality.LOW, false, false);
    private static const SACREDGLOW_FILTER:GlowFilter = new GlowFilter(0, 0.5, 12, 12, 2.5, BitmapFilterQuality.LOW, false, false);
    ...
    public static function outlineGlow(_arg1:BitmapData, _arg2:uint, _arg3:Number = 1.4, _arg4:Boolean = false):BitmapData {
        ...
        if (_arg2 == 0xd80d38)
        {
            GODSLAYERGLOW_FILTER.color = _arg2;
            _local6.applyFilter(_local6, _local6.rect, PointUtil.ORIGIN, GLOW_FILTER);
        }
        if (_arg2 == 0xd3a625)
        {
