...
import kabam.rotmg.assets.EmbeddedAssets_DreamWorldGroundEmbed_;
import kabam.rotmg.assets.EmbeddedAssets_laserBeam16x32Embed_;
...
public class AssetLoader {
    ...
    private function addImages():void {
        AssetLibrary.addImageSet("DWGround2", new EmbeddedAssets.DreamWorldGround2Embed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("DWGround", new EmbeddedAssets.DreamWorldGroundEmbed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("laserBeam", new EmbeddedAssets.laserBeam16x32Embed_().bitmapData, 16, 32);
