...
public class Options extends Sprite {
    ...
    private static function makeShadowSizeOptionCounter():Vector.<StringBuilder> {
        return (new <StringBuilder>[makeLineBuilder("Big"), makeLineBuilder("Normal"), makeLineBuilder("Small"), makeLineBuilder("Tiny")]);
    }
    ...
    private static function makeHideLabels():Vector.<StringBuilder> {
        return (new <StringBuilder>[new StaticStringBuilder("Off"),
            new StaticStringBuilder("Locked"), new StaticStringBuilder("Guild"), new StaticStringBuilder("Party"), new StaticStringBuilder("GPL")]);
    }
    private static function makeMiniMapLabels():Vector.<StringBuilder> {
        return (new <StringBuilder>[new StaticStringBuilder("Square"), new StaticStringBuilder("Circle")]);
    }
    ...
    private function addChatOptions():void {
        ...
        this.addOptionAndPosition(new KeyMapper("partyChat", "Begin Party Chat", "This key will bring up a party chat in the chat input box."));
        ...
        this.addOptionAndPosition(new KeyMapper("partySummon", "Summon Party", "Summons party members."));
        this.addOptionAndPosition(new KeyMapper("partyAccept", "Accept Party Summons", "Accepts invites from party leaders."));
    }
    ...
    private function addExperimentalOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("drawAura", makeOnOffLabels(), [true, false],"Show Aura","Display a cool aura around your player!",null));
        this.addOptionAndPosition(new ChoiceOption("smartProjectiles", makeOnOffLabels(), [true, false], "Projectile Direction", "Make projectiles face the direction they are going.", null));
        this.addOptionAndPosition(new ChoiceOption("ShadowSize",makeShadowSizeOptionCounter(),[2.5,3,4,6], "Shadow Size", "The bigger the number, the smaller the shadow", null));
    }
    private function addGraphicsOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("hideList", makeHideLabels(), [0, 1, 2, 3, 4], "Hide Players", "Hide players on screen", null));
        ...
        if (Capabilities.playerType == "Desktop") {
            this.addOptionAndPosition(new ChoiceOption("fullscreenMode", makeOnOffLabels(), [true, false], TextKey.OPTIONS_FULLSCREEN_MODE, TextKey.OPTIONS_FULLSCREEN_MODE_DESC, this.onFullscreenChange));
                ...
                this.addOptionAndPosition(new ChoiceOption("bigBag",makeOnOffLabels(),[true,false],"Classic Rare Bag Appearance","The white and black bags look like their old appearance.",null));
        ...
        this.addOptionAndPosition(new ChoiceOption("projectileOutline", makeOnOffLabels(), [true, false], "Proj. Outlines", "Toggles Outlines on Shots.", null));
        ...
        this.addOptionAndPosition(new ChoiceOption("stageScale", makeOnOffLabels(), [StageScaleMode.NO_SCALE, StageScaleMode.NO_SCALE], "Fullscreen", "Turning this off with Hardware Acceleration enabled will break your game.", this.fsv3));
    }
