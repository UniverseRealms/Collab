...
public class Parameters {
    public static const GAME_VERSION:String = "UTReborn.V1.9.9";
    public static const DEV_MODE:Boolean = true;
    public static const IS_AIR:Boolean = true; //Set to 'true' for air client
