...
public class ObjectLibrary {
    ...
    public static function getRedrawnTextureFromType(_arg_1:int, _arg_2:int, _arg_3:Boolean, _arg_4:Boolean = true, _arg_5:Number = 5):BitmapData {
        ...
        if (_local_8 == null && _local_9.hasOwnProperty("Godly")) {
            return (TextureRedrawer.redraw(_local_6, _arg_2, _arg_3, 0xE01DBF, _arg_4, _arg_5, 1.5));
        }
        if (_local_8 == null && _local_9.hasOwnProperty("GodSlayer")) {
            //                             Image, imagesize, padding,glowcolor,smult,  Wholesize
            return (TextureRedrawer.redraw(_local_6, _arg_2, _arg_3, 0xd80d38, _arg_4, _arg_5, 1.4));
        }
        if (_local_8 == null && _local_9.hasOwnProperty("Eternal")) {
            return (TextureRedrawer.redraw(_local_6, _arg_2, _arg_3, 0x6a38ea, _arg_4, _arg_5, 1.5));
        }
        if (_local_8 == null && _local_9.hasOwnProperty("Divine")) {
            return (TextureRedrawer.redraw(_local_6, _arg_2, _arg_3, 0xf04040, _arg_4, _arg_5, 1.5));
