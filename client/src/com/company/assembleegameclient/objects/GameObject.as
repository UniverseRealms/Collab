...
public class GameObject extends BasicObject {
    ...
    public function damage(_arg1:int, _arg2:int, _arg3:Vector.<uint>, dead:Boolean, _arg5:Projectile):void {
        var _local7:int;
        var _local8:uint;
        ...
        if (!dead
                && ((Parameters.data_.noEnemyDamage && this.props_.isEnemy_ && (_arg5 == null || _arg5.ownerId_ != map_.player_.objectId_))
    ...
    override public function drawShadow(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void {
        ...
        var _local4:Number = (((this.size_ / 100) * (this.props_.shadowSize_ / 100)) /Parameters.data_.ShadowSize/** this.sizeMult_*/);
