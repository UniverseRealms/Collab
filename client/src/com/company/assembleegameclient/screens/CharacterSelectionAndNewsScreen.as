...
public class CharacterSelectionAndNewsScreen extends Sprite {
    ...
    private function createCharacterListChar():void {
        ...
        this.addChild(rightarr);
        this.removeChild(leftarr);
    ...
    private function createCharacterListGrave():void {
        ...
        this.addChild(leftarr);
        this.removeChild(rightarr);
    ...
    private function Leftarr():void {
        ...
        this.leftarr.graphics.lineStyle(2, 0xf0f0f0);

        this.leftarr.graphics.beginFill(0xffffff, 1);
        ...
        leftarr.addEventListener(MouseEvent.MOUSE_DOWN, onOpenCharacters);
    ...
    private function Rightarr():void {
        ...
        this.rightarr.graphics.lineStyle(2, 0xf0f0f0);

        this.rightarr.graphics.beginFill(0xffffff, 1);
        ...
        rightarr.addEventListener(MouseEvent.MOUSE_DOWN, onOpenGraveyard);
