...
public class StatData {
    ...
    public static const AIR_STORAGE:int = 161;
    public static const WATER_STORAGE:int = 162;
    public static const EARTH_STORAGE:int = 163;
    public static const FIRE_STORAGE:int = 164;
    public static const LOCKER_LOOTBOX:int = 152;
    public static const EVENT_LOOTBOX:int = 153;
    public static const PARTYID:int = 154;
    public static const PARTYRANK:int = 170;
    public static const A_POTIONS:int = 171;
    public static const D_POTIONS:int = 172;
    public static const S_POTIONS:int = 173;
    public static const DE_POTIONS:int = 174;
    public static const V_POTIONS:int = 175;
    public static const W_POTIONS:int = 176;
    public static const L_POTIONS:int = 177;
    public static const M_POTIONS:int = 178;
    public static const R_POTIONS:int = 179;
    public static const LU_POTIONS:int = 180;
