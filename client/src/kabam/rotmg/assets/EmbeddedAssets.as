...
import kabam.rotmg.assets.EmbeddedAssets_CusEnemProj16_Embed_;

public class EmbeddedAssets {
    public static var DreamWorldGround2Embed_:Class = EmbeddedAssets_DreamWorldGround2Embed_;
    public static var DreamWorldGroundEmbed_:Class = EmbeddedAssets_DreamWorldGroundEmbed_;
    public static var laserBeam16x32Embed_:Class = EmbeddedAssets_laserBeam16x32Embed_;
    ...
    public static var SLEnv16x16Embed_:Class = EmbeddedAssets_ShadowlandEnv16x16Embed_;
    public static var SLEnv8x8Embed_:Class = EmbeddedAssets_ShadowlandEnv8x8Embed_;
    public static var SLEnem32x32Embed_:Class = EmbeddedAssets_ShadowlandEnem32x32Embed_;
    public static var SLEnem16x16Embed_:Class = EmbeddedAssets_ShadowlandEnem16x16Embed_;
    public static var SLEnem8x8Embed_:Class = EmbeddedAssets_ShadowlandEnem8x8Embed_;
    public static var CusEnem32x32Embed_:Class = EmbeddedAssets_CusEnem32x32Embed_;
    public static var DWObjects32x32Embed_:Class = EmbeddedAssets_DWObjects32x32Embed_;
    public static var SummerBreezeObjects16x8Embed_:Class = EmbeddedAssets_SummerBreezeObjects16x8Embed_;
    public static var SummerBreezeObjects16x16Embed_:Class = EmbeddedAssets_SummerBreezeObjects16x16Embed_;
    public static var lofiGoldenEmbed_:Class = EmbeddedAssets_lofiGoldenEmbed_;
    public static var CusEnv16x16_:Class = EmbeddedAssets_CusEnv16x16_Embed_;
    public static var DreamWorldObjects16x8Embed_:Class = EmbeddedAssets_DreamWorldObjects16x8Embed_;
    public static var DreamWorldObjects16x16Embed_:Class = EmbeddedAssets_DreamWorldObjects16x16Embed_;
    public static var lofiObjectAnimEmbed_:Class = EmbeddedAssets_lofiObjAnimEmbed_;
    public static var lofiSacredEmbed_:Class = EmbeddedAssets_lofiSacredEmbed_;
    public static var lofiSacredProjsEmbed_:Class = EmbeddedAssets_lofiSacredProjsEmbed_;
    public static var customobjects32x32Embed_:Class = EmbeddedAssets_customobjects32x32Embed_;
    public static var customobjects16x16Embed_:Class = EmbeddedAssets_customobjects16x16Embed_;
    public static var customground8x8Embed_:Class = EmbeddedAssets_customground8x8Embed_;
    ...
    public static var potStorageEmbed_:Class = EmbeddedAssets_potionStorage16x32Embed_;
    ...
    public static var Cus16x16EnemSepFrame:Class = EmbeddedAssets_Cus16x16EnemSepFrame_Embed_;
    public static var Cus16x16EnemSheet:Class = EmbeddedAssets_Cus16x16EnemSheet_Embed_;
    public static var CusEnemProj_:Class = EmbeddedAssets_CusEnemProj_Embed_;
    public static var CusEnemProj16_:Class = EmbeddedAssets_CusEnemProj16_Embed_;
    public static var CusEnv_:Class = EmbeddedAssets_CusEnv_Embed_;
    ...
    public static var skeletonEmbed_:Class = EmbeddedAssets_skeletonEmbed_;
