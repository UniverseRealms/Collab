...
import kabam.rotmg.potionStorage.PotionPanelMediator;
import kabam.rotmg.potionStorage.UI.PotionStorage;
import kabam.rotmg.potionStorage.UI.PotionStorageMediator;
import kabam.rotmg.questMaster.QuestMasterPanel;
import kabam.rotmg.questMaster.QuestMasterPanelMediator;
import kabam.rotmg.questMaster.UI.QuestMaster;
import kabam.rotmg.questMaster.UI.QuestMasterMediator;
...
public class UIConfig implements IConfig {
    ...
    public function configure():void {
        ...
        this.injector.map(UpdateMarksSignal).asSingleton();
        ...
        this.mediatorMap.map(PotionStorage).toMediator(PotionStorageMediator);
        this.mediatorMap.map(PotionPanel).toMediator(PotionPanelMediator);
        this.mediatorMap.map(QuestMaster).toMediator(QuestMasterMediator);
        this.mediatorMap.map(QuestMasterPanel).toMediator(QuestMasterPanelMediator);
