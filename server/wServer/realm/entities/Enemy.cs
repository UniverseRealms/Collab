...
namespace wServer.realm.entities
{
    public class Enemy : Character
    {
        ...
        public override void Tick()
        {
            ...
            if (!stat && HasConditionEffect(ConditionEffects.Bleeding) && !(HasConditionEffect(ConditionEffects.Invincible) || HasConditionEffect(ConditionEffects.Invulnerable))) HP -= (int)(MaximumHP / 500f * CoreConstant.worldTickMs / 1000f);
