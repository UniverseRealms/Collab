...
namespace wServer.realm.entities
{
    partial class Player
    {
        ...
        private void Activate(Item item, Position target)
        {
            ...
            foreach (var eff in item.ActivateEffects)
            {
                switch (eff.Effect)
                {
                    ...
                    case ActivateEffects.GUnlock:
                        AEGuildRaidUnlock(item, target, eff);
                        break;
        ...
        private void AEGuildRaidUnlock(Item item, Position target, ActivateEffect eff)
        {
            var availableSlot = Inventory.GetAvailableInventorySlot(item);

            if (!Owner.Name.Equals("Guild"))
            {
                SendError("You cannot use your raid token here!");
                Inventory[availableSlot] = item;
                return;
            }
            else
        ...
        private void AEIncrementStat(Item item, Position target, ActivateEffect eff)
        {
            ...
            switch (Rank)
            {
                case 0:
                    ...
                    {
                        IncrementSend(item, eff, idx, eff.Amount, 20); // 20
                        return;
                    }
                    break;
                case 20:
                    if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                    {
                        IncrementSend(item, eff, idx, eff.Amount, 50); // 50
                        return;
                    }
                    break;
                case 30:
                    if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                    {
                        IncrementSend(item, eff, idx, eff.Amount, 100); // 100
                        return;
                    }
                    break;
                case 40:
                    if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                    {
                        IncrementSend(item, eff, idx, eff.Amount, 200); // 200
                        return;
                    }
                    break;
                case 70:
                    if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                    {
                        IncrementSend(item, eff, idx, eff.Amount, 1000);
                        return;
                    }
                    break;
                case 90:
        ...
        private void IncrementSend(Item item, ActivateEffect eff, int Stat, int amount, int limit)
        {
            int sendPOT = amount;
            var idx = StatsManager.GetStatIndex((StatsType)eff.Stats);
            var statInfo = Manager.Resources.GameData.Classes[ObjectType].Stats;
            ...
            {
                case 0:
                    if (item.ObjectType == 0xae9 || item.ObjectType == 0x236E)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredLife += sendPOT;
                    ...
                    break;
                case 1:
                    if (item.ObjectType == 0xaea || item.ObjectType == 0x236F)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredMana += sendPOT;
                    ...
                    break;
                case 2:
                    if (item.ObjectType == 0xa1f || item.ObjectType == 0x2368)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredAttack += sendPOT;
                    ...
                    break;
                case 3:
                    if (item.ObjectType == 0xa20 || item.ObjectType == 0x2369)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredDefense += sendPOT;
                    ...
                    break;
                case 4:
                    if (item.ObjectType == 0xa21 || item.ObjectType == 0x236A)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredSpeed += sendPOT;
                    ...
                    break;
                case 5:
                    if (item.ObjectType == 0xa4c || item.ObjectType == 0x236D)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredDexterity += sendPOT;
                    ...
                    break;
                case 6:
                    if (item.ObjectType == 0xa34 || item.ObjectType == 0x236B)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredVitality += sendPOT;
                    ...
                    break;
                case 7:
                    if (item.ObjectType == 0xa35 || item.ObjectType == 0x236C)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredWisdom += sendPOT;
                ...
                case 8:
                    if (item.ObjectType == 0x5823)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredLuck += sendPOT;
                ...
                case 9:
                    if (item.ObjectType == 0x68fd)
                    {
                        if (Stats.Base[idx] >= statInfo[idx].MaxValue)
                        {
                            ...
                            Client.Account.StoredRestoration += sendPOT;
