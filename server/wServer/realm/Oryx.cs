...
namespace wServer.realm
{
    internal class Oryx
    {
        ...
        {
            Tuple.Create("Transcendent Burrower", (ISetPiece) new Burrower()),
            Tuple.Create("Grotesque Serpent", (ISetPiece) new Grotesque()),
            Tuple.Create("Blaze-Born", (ISetPiece) new Blaze()),
            Tuple.Create("Hellfire Lord", (ISetPiece) new Hellfire()),
            Tuple.Create("Bedlamgod", (ISetPiece) new Bedlam()),
            Tuple.Create("Queen of Hearts", (ISetPiece) new QueenofHearts()),
        ...
        private static readonly Tuple<string, TauntData>[] CriticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            Tuple.Create("Pentaract", new TauntData()
            {
                ...
                Killed = new string[] {
                    ...
                    "{PLAYER}, you flea-ridden animal! You destroyed my Pentaract!",
           ...
           Tuple.Create("Truvix, the Lord Wanderer", new TauntData
            ...
            Tuple.Create("Grotesque Serpent", new TauntData
                {
                    Spawn = new string[] {
                        "Surely, these simpletons are no match for the Grotesque Serpent!"
                    },
                    Killed = new string[] {
                        "What a disappointment..."
                    }
                }),
            Tuple.Create("Blaze-Born", new TauntData
                {
                    Spawn = new string[] {
                        "Burn them to cinders, Blaze-Born! Show them the true fears of the abyss!"
                    },
                    Killed = new string[] {
                        "Bah, the abyss isn't as strong as I thought."
                    }
                }),
            Tuple.Create("Transcendent Burrower", new TauntData
                {
                    Spawn = new string[] {
                        "Arise, Burrower! Teach these peasants how weak they truly are!"
                    },
                    Killed = new string[] {
                        "You'll pay for that, {PLAYER}! I will eventually kill you myself!"
                    }
                }),
            ...
            new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>()
        {
            ...
            { WmapTerrain.Mountains, Tuple.Create(
                50, new []
                {
                    Tuple.Create("White Demon", 0.087),
                    Tuple.Create("Sprite God", 0.07),
                    Tuple.Create("Medusa", 0.087),
                    Tuple.Create("Ent God", 0.087),
                    Tuple.Create("Beholder", 0.087),
                    Tuple.Create("Flying Brain", 0.087),
                    Tuple.Create("Slime God", 0.087),
                    Tuple.Create("Ghost God", 0.087),
                    Tuple.Create("Rock Bot", 0.087),
                    Tuple.Create("Djinn", 0.087),
                    Tuple.Create("Leviathan", 0.07),
                    Tuple.Create("Thunder God", 0.007),
                    Tuple.Create("Frost Knight", 0.07),
                })
            },
        };
        ...
        private void SpawnEvent(string name, ISetPiece setpiece)
        {
            ...
            do
            {
                pt.X = _rand.Next(_world.Map.Width / 4, _world.Map.Width * 3 / 4);
                pt.Y = _rand.Next(_world.Map.Width / 4, _world.Map.Height * 3 / 4);
        ...
        public void InitCloseRealm()
        {
            ...
            _world.Timers.Add(new WorldTimer(60000, (w) =>
            {
                if (w == null || w.Deleted) 
                    return;
        ...
        private void CloseRealm()
        {
            ...
            _world.Timers.Add(new WorldTimer(22000, (w) =>
            {
