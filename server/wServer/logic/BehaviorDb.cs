    ...
    public partial class BehaviorDb
    {
        ...
        private static void handleExtraDrops(Tuple<Player, int>[] playerDamage, Enemy e)
        {
            ...
            foreach (var playerInfo in playerDamage)
            {
                ...
                {
                    player.Client.Account.ChanceDenom = player.ChanceDenom = 10000;
            ...
            if (e.ObjectDesc.AirDrop > 0)
            {
                ...
                {
                    Player player = playerInfo.Item1;
                    player.SendInfo("You have obtained " + e.ObjectDesc.AirDrop + " Air Fragments");
            ...
            if (e.ObjectDesc.WaterDrop > 0)
            {
                ...
                {
                    Player player = playerInfo.Item1;
                    player.SendInfo("You have obtained " + e.ObjectDesc.WaterDrop + " Water Fragments");
            ...
            if (e.ObjectDesc.EarthDrop > 0)
            {
                ...
                {
                    Player player = playerInfo.Item1;
                    player.SendInfo("You have obtained " + e.ObjectDesc.EarthDrop + " Earth Fragments");
            ...
            if (e.ObjectDesc.FireDrop > 0)
            {
                ...
                {
                    Player player = playerInfo.Item1;
                    player.SendInfo("You have obtained " + e.ObjectDesc.FireDrop + " Fire Fragments");
            ...
            if (e.ObjectDesc.GoldDrop > 0)
            {
                ...
                {
                    Player player = playerInfo.Item1;
                    player.SendInfo("You have obtained " + e.ObjectDesc.GoldDrop + " Coins");
                    player.Client.Manager.Database.UpdateCredit(player.Client.Account, e.ObjectDesc.GoldDrop);
                    player.Credits += e.ObjectDesc.GoldDrop;
            ...
            if (e.ObjectDesc.OnraneDrop > 0)
            {
                ...
                {
                    Player player = playerInfo.Item1;
                    player.SendInfo("You have obtained " + e.ObjectDesc.OnraneDrop + " Onrane");
                    player.Client.Manager.Database.UpdateOnrane(player.Client.Account, e.ObjectDesc.OnraneDrop);
                    player.Onrane += e.ObjectDesc.OnraneDrop;
            ...
            if (e.ObjectDesc.EternalDrop > 0)
            {
                ...
                {
                    Player player = playerInfo.Item1;
                    player.SendInfo("You have obtained " + e.ObjectDesc.EternalDrop + " Eternal Fragments");
                    player.Client.Manager.Database.UpdateSorStorage(player.Client.Account, e.ObjectDesc.EternalDrop);
                    player.SorStorage += e.ObjectDesc.EternalDrop;
