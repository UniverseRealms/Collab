...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Luna, the Mischievous",
            new State(
                ...
                new State("idle",
                    ...
                    new PlayerWithinTransition(5, "minions")
                    ),
                new State("minions",
                ...
                new State("1",
                    new Shoot(10, count: 8, fixedAngle: 0, shootAngle: 45, projectileIndex: 2, coolDown: 1000),
                    new Shoot(10, count: 4, shootAngle: 15, projectileIndex: 0, coolDown: 500),
                    new ConditionalEffect(ConditionEffectIndex.Armored),
                    new Follow(1.2, 8, 1),
                    new Wander(1.2),
                ...
                new State("2",
                    ...
                    new SpiralShoot(10, 60, 12, projectileIndex: 3, coolDown: 300)
                    )
                ),
            new Threshold(0.01,
          ...
          .Init("Grod, the Cosmic Parasite",
           ...
           .Init("Aleph, the Lost Soul",
            new State(
                ...
                new State("2",
                    new Shoot(10, count: 5, shootAngle: 23, coolDown: 1000, projectileIndex: 0),
                    new Shoot(10, count: 8, fixedAngle: 0, shootAngle: 45, projectileIndex: 6, coolDown: 1000, coolDownOffset: 500),
                    new Follow(0.6, 8, 1),
                    new Wander(0.4),
                ...
                new State("rage2",
                    new Follow(1, 8, 1),
                    new Wander(1),
                    new Shoot(10, count: 6, shootAngle: 20, projectileIndex: 7, coolDown: 1500, coolDownOffset: 0),
                    new Shoot(10, count: 6, shootAngle: 20, projectileIndex: 8, coolDown: 1500, coolDownOffset: 0),
                    new Shoot(10, count: 6, shootAngle: 20, projectileIndex: 9, coolDown: 1500, coolDownOffset: 0),
                    new Shoot(10, count: 6, shootAngle: 20, projectileIndex: 10, coolDown: 1500, coolDownOffset: 0),
                    new Shoot(10, count: 6, shootAngle: 20, projectileIndex: 11, coolDown: 1500, coolDownOffset: 0),
                    new Shoot(10, count: 6, shootAngle: 60, projectileIndex: 1, coolDown: 1500, coolDownOffset: 300),
                    new Shoot(10, count: 6, shootAngle: 60, projectileIndex: 2, coolDown: 1500, coolDownOffset: 300),
                    new Shoot(10, count: 6, shootAngle: 60, projectileIndex: 3, coolDown: 1500, coolDownOffset: 300),
                    new Shoot(10, count: 6, shootAngle: 60, projectileIndex: 4, coolDown: 1500, coolDownOffset: 300),
                    new Shoot(10, count: 6, shootAngle: 60, projectileIndex: 5, coolDown: 1500, coolDownOffset: 300)
                    )
                ),
            new Threshold(0.01,
        ...
        #region Boss + Objects
           ...
           .Init("DW Wall Remover 1",
            new State(
                new RemoveObjectOnDeath("Gate Entry Rotated", 10),
                new RemoveObjectOnDeath("Gate Entry 2 Rotated", 10),
                new RemoveObjectOnDeath("Gate Entry LF Rotated", 10),
                new RemoveObjectOnDeath("Gate Entry LF 2 Rotated", 10),
                new State("Idle",
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true),
                    new EntitiesNotExistsTransition(10, "boom", "Blue Wisp", "Yellow Wisp", "Red Wisp")
                    ),
                new State("boom",
                    new Suicide()
                    )
