...
namespace common.resources
{
    ...
    public enum ConditionEffects : ulong
    {
        ...
        BleedingImmune = (ulong)1 << 63,
        WeakImmune = (ulong)1 << 64
    }
    ...
    public enum ConditionEffectIndex
    {
        ...
        // always keep this last and update accordingly
        Size = 65
    }
    ...
    public class ProjectileDesc
    {
        ...
        public bool LifeLeech { get; }
        public bool GroupLifeLeech { get; }
        ...
        public ProjectileDesc(XElement elem)
        {
            ...
            LifeLeech = elem.Element("EnemyLifeLeech") != null;
            GroupLifeLeech = elem.Element("EnemyGroupLifeLeech") != null;
    ...
    public class ActivateEffect
    {
        ...
        public int Stats { get; }
        public int Stats2 { get; }
        public int Stats3 { get; }
        ...
        public bool UseWisMod2 { get; }
        public bool UseVitMod { get; }
        public bool UseAtkMod { get; }
        ...
        private static readonly List<string> NotImplementedAEs = new List<string>();

        public ActivateEffect(XElement elem)
        {
            if (Enum.IsDefined(typeof(ActivateEffects), elem.Value))
                Effect = (ActivateEffects)Enum.Parse(typeof(ActivateEffects), elem.Value);
            else
            {
                if (!NotImplementedAEs.Contains(elem.Value))
                {
                    NotImplementedAEs.Add(elem.Value);

                    XmlData.log.Warn($"[Activate Effect Exception]: '{elem.Value}' not implemented!");
                }
            }
            ...
            if (elem.Attribute("stat2") != null)
                Stats2 = Utils.FromString(elem.Attribute("stat2").Value);

            if (elem.Attribute("stat3") != null)
                Stats3 = Utils.FromString(elem.Attribute("stat3").Value);
            ...
            if (elem.Attribute("amount3") != null)
                Amount3 = Utils.FromString(elem.Attribute("amount3").Value);
            ...
            if (elem.Attribute("duration2") != null)
                DurationMS2 = (int)(float.Parse(elem.Attribute("duration2").Value) * 1000);
            ...
            if (elem.Attribute("color") != null) // some activated effects use if(color == 0) as a null check, set color to 0x000001 in xml instead
            ...
            if (elem.Attribute("useWisMod2") != null)
                UseWisMod2 = elem.Attribute("useWisMod2").Value.Equals("true");
            else
                UseWisMod2 = UseWisMod;

            if (elem.Attribute("useVitMod") != null)
                UseVitMod = elem.Attribute("useVitMod").Value.Equals("true");

            if (elem.Attribute("useAtkMod") != null)
                UseAtkMod = elem.Attribute("useAtkMod").Value.Equals("true");
            ...
            if (elem.Attribute("randVals") != null)
                RandVals = elem.Attribute("randVals").Value.Replace(" ", "").Split(',');
            ...
            if (elem.Attribute("gifts") != null)
            {
                string[] parsed = elem.Attribute("gifts").Value.Split(',');
                List<ushort> items = new List<ushort>();
                foreach (var i in parsed)
                    items.Add(ushort.Parse(i.Substring(2), NumberStyles.AllowHexSpecifier));
                Gifts = items.ToArray();
            }
        }
    }
    ...
    public class Item
    {
        ...
        public bool Heroic { get; }
        public bool Ancestral { get; }
        public bool Sacred { get; }
        public bool Eternal { get; }
        public bool Divine { get; }
        ...
        public Item(ushort type, XElement elem)
        {
            ...
            Heroic = elem.Element("Heroic") != null;

            Ancestral = elem.Element("Ancestral") != null;

            Sacred = elem.Element("Sacred") != null;

            Eternal = elem.Element("Eternal") != null;

            Divine = elem.Element("Divine") != null;
            ...
            MultiPhase = elem.Element("MultiPhase") != null;
            ...
            HalfHPArmored = elem.Element("HalfHPArmored") != null;
            ...
            PetUse = elem.Element("PetUse") != null;
            ...
            Cooldown = (n = elem.Element("Cooldown")) != null ? (long)(float.Parse(n.Value) * 1000) - 500 : 0;
    ...
    public class EquipmentSetDesc
    {
        ...
        public static EquipmentSetDesc FromElem(ushort type, XElement setElem, out ushort skinType)
        {
            ...
            {
                Type = type,
                Id = setElem.Attribute("id").Value,
                ActivateOnEquipAll = activate.ToArray(),
                Setpieces = setpiece.ToArray()
            };
    ...
    public class SkinDesc
    {
        ...
        public static SkinDesc FromElem(ushort type, XElement skinElem)
        {
            ...
            {
                Type = type,
                ObjDesc = new ObjectDesc(type, skinElem),
                PlayerClassType = (ushort)Utils.FromString(pct.Value),
                Restricted = skinElem.Element("Restricted") != null,
                Expires = skinElem.Element("Expires") != null,
                UnlockSpecial = skinElem.Element("UnlockSpecial") != null,
                NoSkinSelect = skinElem.Element("NoSkinSelect") != null,
                PlayerExclusive = skinElem.Element("PlayerExclusive")?.Value
            };

            var ul = skinElem.Element("UnlockLevel");
            if (ul != null) sd.UnlockLevel = ushort.Parse(ul.Value);
            var cost = skinElem.Element("Cost");
            sd.Cost = cost != null ? int.Parse(cost.Value) : 100;
    ...
    public class ObjectDesc
    {
        ...
        public bool EventGod { get; }
        public bool Lootdrop { get; }
        public int AirDrop { get; }
        public int WaterDrop { get; }
        public int EarthDrop { get; }
        public int FireDrop { get; }
        public int GoldDrop { get; }
        public int OnraneDrop { get; }
        public int EternalDrop { get; }
        public bool Elitedrop { get; }
        public bool UElitedrop { get; }
        public bool EventLootboxDrop { get; }
        ...
        public bool BleedingImmune { get; }
        public bool WeakImmune { get; }
		...
		public ObjectDesc(ushort type, XElement elem)
        {
            ...
            if ((n = elem.Element("MaxHitPoints")) != null)
            {
                ...
                if (adjust > 100000)
                {
                    adjust = Math.Max(100000, (adjust - 100000) / 4 + 100000);
                    Defense = adjust;
                }
            }
            ...
            EventGod = elem.Element("EventGod") != null;
            Lootdrop = elem.Element("Lootdrop") != null;
            if ((n = elem.Element("AirDrop")) != null)
                AirDrop = Utils.FromString(n.Value);
            if ((n = elem.Element("WaterDrop")) != null)
                WaterDrop = Utils.FromString(n.Value);
            if ((n = elem.Element("EarthDrop")) != null)
                EarthDrop = Utils.FromString(n.Value);
            if ((n = elem.Element("FireDrop")) != null)
                FireDrop = Utils.FromString(n.Value);
            if ((n = elem.Element("GoldDrop")) != null)
                GoldDrop = Utils.FromString(n.Value);
            if ((n = elem.Element("OnraneDrop")) != null)
                OnraneDrop = Utils.FromString(n.Value);
            if ((n = elem.Element("EternalDrop")) != null)
                EternalDrop = Utils.FromString(n.Value);
            Elitedrop = elem.Element("Elitedrop") != null;
            UElitedrop = elem.Element("UElitedrop") != null;
            EventLootboxDrop = elem.Element("EventLootboxDrop") != null;
            ...
            BleedingImmune = elem.Element("BleedingImmune") != null;
            WeakImmune = elem.Element("WeakImmune") != null;
            Invincible = elem.Element("Invincible") != null;
    ...
    public class TileDesc
    {
        ...
        public TileDesc(ushort type, XElement elem)
        {
            ...
            ZolTile = elem.Element("ZolTile") != null;
