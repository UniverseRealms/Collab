...
namespace common.resources
{
    ...
    public class NewAccounts : InitSettings
    {
        ...
        public int Lootbox6 { get; }
        public int Lootbox7 { get; }
        public int SorStorage { get; }
        public int AirStorage { get; }
        public int WaterStorage { get; }
        public int EarthStorage { get; }
        public int FireStorage { get; }
        public int ChanceDenom { get; }
        ...
        public NewAccounts(XElement e)
        {
            ...
            AirStorage = GetIntValue("AirStorage");
            WaterStorage = GetIntValue("WaterStorage");
            EarthStorage = GetIntValue("EarthStorage");
            FireStorage = GetIntValue("FireStorage");
            ChanceDenom = 10000;
        }
    }
